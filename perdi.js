...
let colors = ['pink','red', 'pink', 'blue']; //untuk pieplot
let url = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vT3KZAuJtYzwq0ai1wNAM7zDeQcQtImZB2L8142dRSqD_iYOUhLaVmZpBt6Le-L6gmrScjM9GKGsJmq/pub?output=csv';
let dataSheet;
...
function linePlot(xData, yData){ 
  ...
  function barPlot(dataBar){ 
    ...
    var dat = map(dataBar[i], 0, 16, 0, windowHeight/2 ) 
